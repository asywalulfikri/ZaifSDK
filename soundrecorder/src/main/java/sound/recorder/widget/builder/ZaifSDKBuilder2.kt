...
class ZaifSDKBuilder2 private constructor(
    val appName: String?,
    val versionCode: Int?,
    ...
    class Builder(private val context: Context) {
        ...
        fun hasSong(hasSong: Boolean): Builder {
        ...
        fun build(): ZaifSDKBuilder2 {
            val zaifSDKBuilder = ZaifSDKBuilder2(
                appName, versionCode, versionName, applicationId, developerName,
                showNote, showChangeColor, backgroundWidgetColor ?: "#FFFFFF", showListSong, showVolume,hasSong,showTooltip
            )
        ...
        private fun saveToSharedPreferences(zaifSDKBuilder: ZaifSDKBuilder2) {
        ...
        fun loadFromSharedPreferences(): ZaifSDKBuilder2? {
            val sharedPreferences: SharedPreferences = context.getSharedPreferences(
                Constant.KeyShared.shareKey,
                Context.MODE_PRIVATE
            )
            ...
            return if (json != null) {
                gson.fromJson(json, ZaifSDKBuilder2::class.java)
            } else {
                null
            }
        }
