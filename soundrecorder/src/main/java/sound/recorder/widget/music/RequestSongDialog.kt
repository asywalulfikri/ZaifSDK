...
class RequestSongDialog {
    ...
    private fun showSongRequestDialog(context: Context) {
        ...
        root.addView(TextView(context).apply {
            text = context.getString(R.string.request_song)
        ...
        root.addView(TextView(context).apply {
            text = context.getString(R.string.what_song_you_wanna_play)
        ...
        root.addView(TextView(context).apply {
            text = context.getString(R.string.song_in_music)
            setTextColor(Color.parseColor("#BBBBBB"))
            textSize = 12f
            setLineSpacing(0f, 1.4f)
            val lp = LinearLayout.LayoutParams(
        ...
        val etTitle = EditText(context).apply {
            hint = context.getString(R.string.song_title)
        ...
        btnRow.addView(TextView(context).apply {
            ...
            setOnClickListener {
                ...
                if (title.isEmpty()) {
                    ...
                    Toast.makeText(context,context.getString(R.string.song_title_cannot_empty),
                        Toast.LENGTH_SHORT).show()
                    return@setOnClickListener
                }
                d.dismiss()
                submitSongRequest(context, title)
            }
        })
        ...
        FirebaseMessaging.getInstance().token.addOnCompleteListener { task ->
            ...
            FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener {
                    Toast.makeText(context, context.getString(R.string.request_song_success), Toast.LENGTH_LONG).show()
                }
                .addOnFailureListener {
                    Toast.makeText(context, context.getString(R.string.request_song_failed), Toast.LENGTH_SHORT).show()
                }
        }
    }
