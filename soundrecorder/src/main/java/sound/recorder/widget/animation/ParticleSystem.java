...
import sound.recorder.widget.animation.initializers.RotationInitializer;
import sound.recorder.widget.animation.initializers.RotationSpeedInitializer;
import sound.recorder.widget.animation.initializers.ScaleInitializer;
import sound.recorder.widget.animation.initializers.SpeedModuleAndRangeInitializer;
import sound.recorder.widget.animation.initializers.SpeeddByComponentsInitializer;
import sound.recorder.widget.animation.modifiers.AlphaModifier;
import sound.recorder.widget.animation.modifiers.ParticleModifier;
